...
<html>
<head>
<title>BigGrocery ::  Privacy Policy </title>
...
<div class="faq-w3 ">
		<div class="container">
			<div class="spec" style="margin-top: -6%;">
						...
						<div class="panel panel-success">
							<div class="panel-body" style="padding-top: 40px;padding-bottom: 40px;">
								<figure style="text-align: center;">
									<img src="<?=site_url('assets/images/final_big_groccer.png');?>">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="col-md-10">
						<h3>What information is, or may be, collected form you?</h3><br>
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="col-md-10">
						<h3>How do we Collect the Information ?</h3><br>
						<p style="text-align: justify;">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="col-md-10">
						<h3>How is information used ?</h3><br>
						<p style="text-align: justify;">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="col-md-10">
						<h3>With whom your information will be shared?</h3><br>
						<p style="text-align: justify;">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="col-md-10">
						<h3>What Choice are available to you regarding collection, use and distribution of your information ?</h3><br>
						<p style="text-align: justify;">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="col-md-10">
						<h3>How can you correct inaccuracies in the information ?</h3><br>
						<p style="text-align: justify;">
							To correct or update any information you have provided, the Site allows you to do it online. In the event of loss of access details you can send an e-mail to: customerservice@biggrocery.com  
						</p>				
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="col-md-10">
						...
						<p style="text-align: justify;">
							<address>
								nnovative Retail Concepts Pvt Ltd,<br>
								1st Floor, Service Road, Domlur 2nd Stage,<br>
								Off Indiranagar 100ft Road, Bangalore-560071 INDIA<br>
								Tel.: +91 80 3355 1000<br>
								Email id: customerservice@biggrocery.com 
							</address>
						</p>				
					</div>
				</div>
