	...
	<div class="container">
		...
		<div class=" contact-w3">	
			<div class="col-md-5 contact-right">	
				<img src="<?=base_url('assets/images/contact-us.jpg');?>" class="img-responsive" alt="">
				<iframe src="<?=$map?>" style="border:0;height:334px;"></iframe>
			</div>
			<div class="col-md-7 contact-left">
				...
				<ul class="contact-list">
					...
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:<?=$mail?>"><?=$mail?></a></li>
