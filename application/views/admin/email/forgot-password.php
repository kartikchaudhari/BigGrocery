...
<body style="background-color: #e9ecef;">
  ...
  <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Dear, <?=$to?>, we have received password request for your BigGrocery account.
  </div>
  <!-- end preheader -->
          ...
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="<?=base_url()?>" target="_blank" style="display: inline-block;">
                <img src="https://image.ibb.co/n2i6HK/big_Brocery_resized.jpg" alt="Logo" border="0" style="display: block;">
              </a>
            </td>
          </tr>
        </table>
