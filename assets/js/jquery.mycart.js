  ...
  var loadMyCartEvent = function(userOptions){
    ...
    var drawTable = function(){
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td></td>' +
        '<td><strong>&#8377;</strong><strong id="' + idGrandTotal + '"></strong></td>' +
        '<td></td>' +
        '</tr>'
      ...
      if(products.length && discountPrice !== null) {
        $cartTable.append(
          ...
          '<td></td>' +
          '<td></td>' +
          '<td><strong>&#8377;</strong><strong id="' + idDiscountPrice + '"></strong></td>' +
          '<td></td>' +
          '</tr>'
        );
      }
    ...
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      $(this).parent("td").next("." + classProductTotal).html("&#8377;" +price * quantity);
